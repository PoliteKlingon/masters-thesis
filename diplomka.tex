...
\section{Local data management}
malo creations, hodne mutations, state-dependent data, timing is crucial

-> intercepting requests, storing a queue

-> why not hybrid? huge offline independence not needed, it's overkill
\subsection{Axios Interceptor}
The actual implementation of the middleware, using axios

request queue

incorporating it into the data - example of combining cache and resuest queue
\section{Synchronization}
