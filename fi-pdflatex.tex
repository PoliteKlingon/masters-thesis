...
\thesissetup{
    ...
    title       = {A Running App for Mixing Audio Tracks based on the Current Runner's Cadence},
    TeXtitle    = {A Running App for Mixing Audio Tracks based on the Current Runner's Cadence},
    keywords    = {Android, application, Audio, Human motion data, Kotlin, mobile application},
    TeXkeywords = {Android, application, Audio, Human motion data, Kotlin, mobile application},
    abstract    = {%
